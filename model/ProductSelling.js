...
class ProductSelling {
    // Select
    getAllRawData() {
        return database.connectAndQuery("select * from public.product_selling")
    }
    ...
    getSellingData (payment_type,paymenttype_id,customer_id,customer,selling_type,sellingtype_id) {
